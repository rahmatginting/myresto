...
<div id="sidebar">
    ...
    <div id="sidebar-brand" class="themed-background">
        <a href="index.php" class="sidebar-title">
            <i class="fa fa-cube"></i> <span class="sidebar-nav-mini-hide">Resto<strong>Bot</strong></span>
        </a>
    </div>
    <!-- END Sidebar Brand -->
    ...
    <div id="sidebar-extra-info" class="sidebar-content sidebar-nav-mini-hide">
        <div class="text-center">
            <small>Developed by <a href="http://www.zeus-ibe.com" target="_blank">Zeus Technology</a></small><br>
            <small><span id="year-copy"></span> &copy; <a href="www.zeus-ibe.com" target="_blank"><?php echo $template['name'] . ' ' . $template['version']; ?></a></small>
        </div>
    </div>
